...
export RIBBOT_SPOT_ENABLED="${RIBBOT_SPOT_ENABLED:-false}"
export RIBBOT_NFT_TRADING_ENABLED="${RIBBOT_NFT_TRADING_ENABLED:-true}"
export RIBBOT_TRADING_ENABLED="${RIBBOT_TRADING_ENABLED:-false}"
export RIBBOT_TRADING_DRY_RUN="${RIBBOT_TRADING_DRY_RUN:-true}"
export RIBBOT_ACTIVITY_ALERTS_ENABLED="${RIBBOT_ACTIVITY_ALERTS_ENABLED:-true}"
