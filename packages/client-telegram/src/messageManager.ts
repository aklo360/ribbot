...
export class MessageManager {
    ...
    private async _shouldRespond(
        ...
        // Get message text from either text or caption
        const messageText = "text" in message 
            ? message.text 
            : "caption" in message && typeof message.caption === "string"
                ? message.caption
                : "";

        // Check if message starts with "@sbf_ribbot" (case insensitive)
        ...
        if ("text" in message || ("caption" in message && typeof message.caption === "string")) {
